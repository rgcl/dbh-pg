...
function DBH(setting, driver) {
    ...
    this.pseudoSafeUpdates = !!setting.pseudoSafeUpdates;
}
...
DBH.prototype.conn = function conn(scope) {
    var me = this,
        connection = new Connection(null, scope || {}, me.verbose, me.pseudoSafeUpdates);
...
// Add proxy to require('bluebird').using
DBH.using = Promise.using;
